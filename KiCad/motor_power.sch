...
U 1 1 5BB27603
P 5750 7100
F 0 "#PWR075" H 5750 6850 50  0001 C CNN
...
AR Path="/5BA75957/5BCCBC60" Ref="#PWR054"  Part="1" 
F 0 "#PWR054" H 1550 650 50  0001 C CNN
...
AR Path="/5BA75957/5BCEAFDC" Ref="#PWR058"  Part="1" 
F 0 "#PWR058" H 1950 1800 50  0001 C CNN
...
Wire Wire Line
	1950 1950 1950 2050
$Comp
L Snack_Machine:INA219 U4
U 1 1 5BC6BBF3
P 4900 6950
F 0 "U4" H 4900 7365 50  0000 C CNN
...
AR Path="/5BA75957/5BC7E4FA" Ref="#PWR055"  Part="1" 
F 0 "#PWR055" H 3900 650 50  0001 C CNN
...
AR Path="/5BA75957/5BC7E524" Ref="#PWR059"  Part="1" 
F 0 "#PWR059" H 4300 1800 50  0001 C CNN
...
AR Path="/5BA75957/5BC81D07" Ref="#PWR056"  Part="1" 
F 0 "#PWR056" H 6250 650 50  0001 C CNN
...
AR Path="/5BA75957/5BC81D31" Ref="#PWR060"  Part="1" 
F 0 "#PWR060" H 6650 1800 50  0001 C CNN
...
AR Path="/5BA75957/5BC8690D" Ref="#PWR057"  Part="1" 
F 0 "#PWR057" H 8600 650 50  0001 C CNN
...
AR Path="/5BA75957/5BC86937" Ref="#PWR061"  Part="1" 
F 0 "#PWR061" H 9000 1800 50  0001 C CNN
...
AR Path="/5BA75957/5BC92727" Ref="#PWR062"  Part="1" 
F 0 "#PWR062" H 1550 2500 50  0001 C CNN
...
AR Path="/5BA75957/5BC92751" Ref="#PWR066"  Part="1" 
F 0 "#PWR066" H 1950 3650 50  0001 C CNN
...
AR Path="/5BA75957/5BC9276C" Ref="#PWR063"  Part="1" 
F 0 "#PWR063" H 3900 2500 50  0001 C CNN
...
AR Path="/5BA75957/5BC92796" Ref="#PWR067"  Part="1" 
F 0 "#PWR067" H 4300 3650 50  0001 C CNN
...
AR Path="/5BA75957/5BC927B1" Ref="#PWR064"  Part="1" 
F 0 "#PWR064" H 6250 2500 50  0001 C CNN
...
AR Path="/5BA75957/5BC927DB" Ref="#PWR068"  Part="1" 
F 0 "#PWR068" H 6650 3650 50  0001 C CNN
...
AR Path="/5BA75957/5BC927F6" Ref="#PWR065"  Part="1" 
...
AR Path="/5BA75957/5BC92820" Ref="#PWR069"  Part="1" 
F 0 "#PWR069" H 9000 3650 50  0001 C CNN
...
U 1 1 5BCD27ED
P 3800 7300
F 0 "#PWR077" H 3800 7050 50  0001 C CNN
...
U 1 1 5BCEEBDE
P 5550 7650
F 0 "#PWR079" H 5550 7400 50  0001 C CNN
...
$EndComp
$Comp
L Snack_Machine:INA180B3 U5
U 1 1 5C27E419
P 2050 7050
F 0 "U5" H 2025 7375 50  0000 C CNN
...
U 1 1 5C27F4F5
P 1100 6250
F 0 "#PWR070" H 1100 6100 50  0001 C CNN
...
U 1 1 5C291CA1
P 1100 6650
F 0 "#PWR073" H 1100 6400 50  0001 C CNN
...
U 1 1 5C291D2E
P 2550 6850
F 0 "#PWR074" H 2550 6700 50  0001 C CNN
...
U 1 1 5C340246
P 1500 7750
F 0 "#PWR081" H 1500 7500 50  0001 C CNN
...
U 1 1 5C3C541B
P 1350 7750
F 0 "#PWR080" H 1350 7500 50  0001 C CNN
...
U 1 1 5C4433AA
P 3800 6350
F 0 "#PWR072" H 3800 6200 50  0001 C CNN
...
U 1 1 5C443BBD
P 3500 6350
F 0 "#PWR071" H 3500 6200 50  0001 C CNN
...
U 1 1 5C46696D
P 3500 7300
F 0 "#PWR076" H 3500 7050 50  0001 C CNN
